...
_DEFAULT_CONFIG: dict[str, Any] = {
    ...
    "npc_autonomy": {
        ...
        "idle_threshold_s": 8,
        "think_interval_s": 12,
        "speech_cooldown_s": 15,
        "critical_speech_cd_mul": 0.5,
        "stance_change_cooldown_s": 25,
        "intent_ttl_s": 30,
        "noop_backoff_s": [15, 30, 60],
        "rule_noop_after": 2,
        "require_scene_change": True,
        "stale_force_think_s": 75,
        "recent_lines_max": 8,
        ...
        "triggers": {
            ...
            "player_idle_for_help_s": 8,
            "social_beat_s": 45,
            "periodic_fallback_s": 75,
