...
观测维度 / 动作空间 / 画布常量未改，可在现有 8000 万步 checkpoint 上 **resume 微调**。
...
/opt/miniconda3/envs/roge/bin/python -m rl.train \
  --resume rl/checkpoints/assault_79999360_steps.zip \
  --timesteps 80100000 \
  --run-name assault_combat_v3_finetune

# 2. 导出
/opt/miniconda3/envs/roge/bin/python -m rl.export_onnx \
  --model rl/checkpoints/assault_best/best_model.zip --verify
